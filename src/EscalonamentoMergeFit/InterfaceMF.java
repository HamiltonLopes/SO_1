...
public class InterfaceMF extends JFrame {
	...
	public InterfaceMF(Fila q, Fila q2, Fila q3, Fila q4, ArrayList<CoreMerge> cores, ArrayList<Processo> terminados) {
		...
		JLabel lblListasTop = new JLabel("Lista de blocos"); // LABEL QUE INDICA QUE O CAMPO ABAIXO Sﾃグ OS BLOCOS
		lblListasTop.setForeground(new Color(153, 255, 204)); // CONFIGURAﾃ�ﾃグ DE COR DE FONTE
		lblListasTop.setFont(new Font("Dialog", Font.BOLD, 11)); // CONFIGURAﾃ�ﾃグ DE FONTE
