...
public class InterfaceInicialMF extends JFrame {
	...
	public InterfaceInicialMF(){
		...
		btnComear.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				MergeFit.processos = Integer.parseInt(caixaProcessos.getText());
				MergeFit.cores = Integer.parseInt(caixaCores.getText());
				MergeFit.quantum = Integer.parseInt(caixaQuantun.getText());
				...
				MemoriaMerge.MEMORIA_TOTAL = Integer.parseInt(qtdMemoria.getText());// ALIMENTA A VARIAVEL PARA SABER O TAMANHO TOTAL DA MEMORIA EM BYTES
				MergeFit mrr = new MergeFit();
				mrr.start();
				fechar();
				//mrr.iniciar();
			}
